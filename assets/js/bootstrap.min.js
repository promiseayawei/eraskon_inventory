				...
				? (function (t, e, i) {
						return function s(n) {
							...
							for (let { target: r } = n; r && r !== this; r = r.parentNode)
								for (const a of o) if (a === r) return F(n, { delegateTarget: r }), s.oneOff && j.off(t, n.type, e, i), i.apply(r, [n]);
						};
				  })(t, i, r)
				: (function (t, e) {
						return function i(s) {
	...
	class fe extends W {
		constructor(t, e) {
			super(t, e),
				...
				(this._menu = K.next(this._element, re)[0] || K.prev(this._element, re)[0] || K.findOne(re, this._parent)),
		...
		_getTemplateFactory(t) {
			return (
				this._templateFactory
					...
					: (this._templateFactory = new Ai({ ...this._config, content: t, extraClass: this._resolvePossibleFunction(this._config.customClass) })),
				this._templateFactory
			);
		}
	...
	class ms extends W {
		constructor(t) {
			super(t),
				...
				this._parent && (this._setInitialAttributes(this._parent, this._getChildren()), j.on(this._element, ts, (t) => this._keydown(t)));
		}
		static get NAME() {
			return "tab";
		}
