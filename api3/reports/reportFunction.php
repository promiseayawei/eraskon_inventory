...
function createReport($userInput)
{
    global $conn;
    ...
    // $project_director_id = mysqli_real_escape_string($conn, $userInput['project_director_id']);
            ...
            if($role == "mobilizer"){
                ...
                $query = "INSERT INTO records (fullname, phone, mobilizer, field_officer, supervisor, project_manager, project_director) 
                VALUES (?, ?, ?, ?, ?, ?, ?)";
                ...
                $stmt->bind_param(
                "sssssss", $fullname, $phone, $mobilizer_id, $field_officer_id, $supervisor_id, $project_manager_id, $project_director_id);
                ...
                // Prepare the SQL query
                $query = "INSERT INTO records (fullname, phone,  field_officer, supervisor, project_manager, project_director) 
                VALUES (?, ?, ?, ?, ?, ?)";
                ...
                // Bind parameters to the prepared statement
                $stmt->bind_param(
                "ssssss", $fullname, $phone,  $field_officer_id, $supervisor_id, $project_manager_id, $project_director_id);
                ...
                // Prepare the SQL query
                $query = "INSERT INTO records (fullname, phone,  supervisor, project_manager, project_director) 
                VALUES (?, ?, ?, ?, ?)";
                ...
                // Bind parameters to the prepared statement
                $stmt->bind_param(
                "sssss", $fullname, $phone,  $supervisor_id, $project_manager_id, $project_director_id);
