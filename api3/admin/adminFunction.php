...
function createProjectManager($userInput)
{
    ...
    if (empty(trim($project_director_first_name))) {
    ...
    //     return error422('Enter your project director');
            ...
            $query = "INSERT INTO project_manager (first_name, last_name, state, lga, town) VALUES ('$first_name', '$last_name', '$state', '$lga', '$town')";
            ...
            if ($result) {
                ...
                $query = "INSERT INTO project_manager_log (description, first_name, last_name, state, lga, town) VALUES ('$description','$first_name', '$last_name', '$state', '$lga', '$town')";
...
function getMobilizer($userParams)
{
    global $conn;
